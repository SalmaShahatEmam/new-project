...
INTRO,
    ...
    'postman' => [
        ...
        'overrides' => [
            ...
            'variable.1.value' => 'en',
            'variable.2.id' => 'token',
            'variable.2.key' => 'token',
            'variable.2.type' => 'string',
            'variable.2.name' => 'string',
            'variable.2.value' => 'token',
            'variable.3.id' => 'apiKey',
            'variable.3.key' => 'apiKey',
            'variable.3.type' => 'string',
            'variable.3.name' => 'string',
            'variable.3.value' => 'apiKey',
            // headers
            ...
            'auth.bearer.0.value' => "{{token}}",
            'auth.bearer.0.type' => "string",
            // 'info.version' => '2.0.0',
        ],
    ],
